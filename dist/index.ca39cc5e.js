...
window.onload = function() {
    let todos = (0, _functions.getTodosFromLS)();
    let removedTodos = (0, _functions.getRemovedTodosFromLS)();
...
},{"./functions":"dxSxr"}],"dxSxr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTodosFromLS", ()=>getTodosFromLS);
parcelHelpers.export(exports, "getRemovedTodosFromLS", ()=>getRemovedTodosFromLS);
...
function getRemovedTodosFromLS() {
    let todos = JSON.parse(localStorage.getItem("removedTodosInLs") || "[]");
    return todos;
}
const addTodoFromForm = ()=>{
    ...
    form.addEventListener("submit", (e)=>{
        e.preventDefault();
        if (todoInput.value !== "") {
            let newTodo = new (0, _todo.Todo)(todoInput.value, false);
            todos.push(newTodo);
            ...
            const messageBox = document.getElementById("emptyInput");
            messageBox.innerHTML = "Du m\xe5ste skriva en todo innan du l\xe4gger till";
        }
    });
};
const createTodoHtml = (todos)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./models/Todo":"6LFGW"}],"gkKU3":[function(require,module,exports) {
...
},{}],"6LFGW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
